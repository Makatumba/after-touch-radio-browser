import type {FilterOption, SortKey, State} from '../state';
import {localizeFilterOptions, SORT_LABEL_KEYS} from '../i18n';

const SORT_KEYS: SortKey[] = ['name_asc', 'name_desc', 'clickcount', 'clicktrend', 'votes'];
